			...
			textobjects = {
				select = {
					...
					keymaps = {
						...
						["ob"] = { query = "@block.outer", desc = "Select outer part of a block region" }, -- overrides default text object block of parenthesis to parenthesis
						...
						["of"] = { query = "@function.outer", desc = "Select outer part of a function region" },
